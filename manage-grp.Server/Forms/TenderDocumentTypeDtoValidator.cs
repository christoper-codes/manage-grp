...
public class TenderDocumentTypeDtoValidator : AbstractValidator<TenderDocumentTypeDto>
{
    public TenderDocumentTypeDtoValidator(DependencyService dependencyService)
    {
