                            ...
                            <v-radio value="free" color="primary" class="label-op-1">
                                <template v-slot:label>
                                    <div>
                                        ...
                                        <span class="d-block text-subtitle-1 textSecondary font-weight-medium">Delivery on Monday 8 Jun</span>
                                    </div>
                                </template>
                            </v-radio>
                        </div>
                            ...
                            <v-radio value="paid" color="primary" class="label-op-1">
                                <template v-slot:label>
                                    <div>
                                        ...
                                        <span class="d-block text-subtitle-1 textSecondary font-weight-medium">Delivery on Friday 5 Jun</span>
                                    </div>
                                </template>
                            </v-radio>
                        </div>
