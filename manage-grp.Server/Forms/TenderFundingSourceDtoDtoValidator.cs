...
public class TenderFundingSourceDtoValidator : AbstractValidator<TenderFundingSourceDto>
{
    public TenderFundingSourceDtoValidator(DependencyService dependencyService)
    {
